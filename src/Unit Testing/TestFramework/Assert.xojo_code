...
Protected Class Assert
	...
	#tag Method, Flags = &h0, Description = 50617373657320746865207465737420696620746865204350552773207374617465206D617463686573207468652065787065637465642073746174652E
		Sub StatesEqual(cpu As MOS6502.CPU, expectedState As CPUState, initialState As CPUState)
