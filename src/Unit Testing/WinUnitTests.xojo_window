...
Begin DesktopWindow WinUnitTests
   ...
   Begin DesktopGroupBox GroupBoxes
      ...
      Begin DesktopLabel TestDurationLabel
         ...
         Width           =   100
      End
      Begin DesktopTextArea ExpectedState
         AllowAutoDeactivate=   True
         ...
         Width           =   525
      End
      Begin DesktopTextArea ActualState
         AllowAutoDeactivate=   True
         AllowFocusRing  =   False
         AllowSpellChecking=   True
         AllowStyledText =   True
      ...
      Begin DesktopLabel LabelDuration
         ...
         Width           =   100
      End
      Begin DesktopLabel TestMessage
         AllowAutoDeactivate=   True
         Bold            =   False
         Enabled         =   True
         FontName        =   "System"
   ...
   Begin UnitTestingToolbar MyToolbar
      ...
      Visible         =   True
   End
   Begin OpcodeTestController Controller
      AllTestCount    =   0
      Duration        =   0.0
      FailedCount     =   0
      GroupCount      =   0
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  // Set the test CPU state text fields to a monospace font.
		  ExpectedState.FontName = GetSystemMonospaceFontName
		  ActualState.FontName = GetSystemMonospaceFontName
		End Sub
	#tag EndEvent
	...
	#tag Method, Flags = &h0, Description = 
		Function GetSystemMonospaceFontName() As String
		  /// Return a sensible monospace font family.
		  ...
		  #ElseIf TargetLinux Then
		    Return FontName = "DejaVu Sans Mono"
		  #EndIf
	...
	#tag Method, Flags = &h21, Description = 5265706F736974696F6E7320616E7920636F6E74726F6C732074686174206172656E2774206D616E61676564206175746F6D61746963616C6C7920627920586F6A6F2E
		Private Sub RepositionControls()
		  ...
		  ExpectedState.Width = outputWidth
		  
		  ActualState.Left = (GroupBoxes(0).Left + GroupBoxes(0).Width) - outputWidth - 8
		  ActualState.Width = outputWidth
		  
		  LabelActualOutput.Left = ActualState.Left
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub UpdateTestSummary()
		  ...
		  TestMessage.TextColor = If(result = "Passed", Color.RGB(78, 143, 0), Color.Red)
